---
titulo: "Já foi nossa casa: BNDES inicia projeto para revitalizar a histórica Estação Leopoldina no Rio"
...
destaque: true
tags: ["Estação Leopoldina", "BNDES", "História", "Ramal Guapimirim", "Saracuruna", "Ferrovia"]
---
...
![Vista aérea da Estação Leopoldina e seu enorme pátio ferroviário](/fotos/leopoldina-vista-aerea.jpg)
...
1. **Restauração do Prédio Principal:** Recuperação da fachada e do saguão monumental da Estação Barão de Mauá para fins culturais e comerciais.
2. **Habitação:** Utilização dos terrenos ociosos no entorno do complexo para a construção de moradias populares e de classe média, aproximando a população do centro.
3. **Polo de Mobilidade:** Reintegração da área com sistemas modernos de transporte, incluindo o VLT e possíveis novas conexões.

## Um novo capítulo para as ferrovias

A notícia da revitalização da Leopoldina chega em um momento de efervescência para a mobilidade do estado. Como acompanhamos no **emguapi.com**, a operação dos nossos trens está passando por [uma transição histórica com a saída da SuperVia e a chegada da Nova Via Mobilidade](/noticias/nova-via-mobilidade-assume-trens-guapimirim).
