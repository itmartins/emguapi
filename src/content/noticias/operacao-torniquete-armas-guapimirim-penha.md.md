...
destaque: true
tags: ["Operação Torniquete", "Polícia Civil", "Polícia Militar", "Comando Vermelho", "Tráfico de Armas", "Guapimirim", "Complexo da Penha"]
---
...
<figure class="my-6">
  <img src="https://www.rj.gov.br/seguranca/sites/default/files/inline-images/2_2.JPG" alt="Agentes das forças de segurança em operação" class="w-full rounded-lg shadow-md border border-gray-200">
  <figcaption class="text-[10px] text-gray-500 mt-2 text-center uppercase tracking-widest font-bold">Foto: ASCOM / SESP RJ - Governo do Estado do Rio de Janeiro</figcaption>
</figure>
