...
destaque: false
tags: ["SuperVia", "Ramal Guapimirim", "TrensRJ", "Nova Permissionária", "Transporte Público", "Abandono"]
---
...
<figure class="my-6">
  ...
  <figcaption class="text-[10px] text-gray-500 mt-2 text-center uppercase tracking-widest font-bold">O desgaste do sistema reflete anos sem investimentos no interior. (Créditos: Google Maps)</figcaption>
</figure>
