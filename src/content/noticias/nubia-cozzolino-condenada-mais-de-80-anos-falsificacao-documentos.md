...
destaque: true
tags: ["Núbia Cozzolino", "Magé", "Justiça", "MPRJ", "Falsificação", "Documentos Judiciais", "Política", "Cozzolino"]
---
...
<div class="flex justify-center my-8">
  <div class="w-full max-w-[800px] aspect-video rounded-xl overflow-hidden shadow-lg bg-black">
    <iframe
      src="https://www.youtube.com/embed/BsePr9N8f-I"
      title="Ex-prefeita de Magé Núbia Cozzolino é condenada a mais de 50 anos de prisão - SBT Rio"
      width="100%"
      height="100%"
      style="border:none;"
...
<strong>Vídeo:</strong> SBT Rio noticia a condenação da ex-prefeita de Magé, Núbia Cozzolino. Reprodução/YouTube.
</p>

<figure>
  <img src="/fotos/nubia-cozzolino.jpg" alt="Núbia Cozzolino, ex-prefeita de Magé">
  <figcaption>Núbia Cozzolino foi prefeita de Magé por dois mandatos e posteriormente passou a responder a processos relacionados à administração municipal e à adulteração de documentos judiciais. Foto: Rafael Wallace / Alerj</figcaption>
</figure>
...
Até a publicação desta reportagem, o [<strong>em</strong>guapi<strong style="color: #dc2626;">.com</strong>](emguapi.com) não havia localizado manifestação pública da defesa de Núbia Cozzolino especificamente sobre a sentença que resultou na pena superior a 80 anos.
